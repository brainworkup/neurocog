...
# This code sorts the data by percentile and then removes duplicate rows based on the percentile variable. The resulting data is then converted to text and appended to the _academics_text_raw.qmd file.
data_text <-
  data |>
