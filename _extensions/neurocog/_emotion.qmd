...
# merge
data_core <- rbind(tbl1, tbl2)
# data <- rbind(tbl1, tbl2, tbl3, tbl4)

# # subset data
# data_qtbl <- data[, c(11, 2, 4, 5, 6)]
# # hack
# colnames(data_qtbl)[1] <- "test_name"
...
# save
gt::gtsave(table_psych, glue("table_psych", ".png"), expand = 10)
# gt::gtsave(table_emotion, glue("table_personality", ".png"), expand = 10)
```
